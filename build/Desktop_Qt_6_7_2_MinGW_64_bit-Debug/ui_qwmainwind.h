...
public:
    ...
    void setupUi(QMainWindow *QWMainWind)
    {
        ...
        QWMainWind->setToolButtonStyle(Qt::ToolButtonStyle::ToolButtonTextUnderIcon);
        ...
        actDisplay = new QAction(QWMainWind);
        actDisplay->setObjectName("actDisplay");
        QIcon icon11;
        icon11.addFile(QString::fromUtf8(":/images/images/tools-fill.bmp"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        actDisplay->setIcon(icon11);
        actDisplay->setMenuRole(QAction::MenuRole::TextHeuristicRole);
        ...
        mainToolBar->addAction(actDisplay);
    ...
    void retranslateUi(QMainWindow *QWMainWind)
    {
        ...
        actDisplay->setText(QCoreApplication::translate("QWMainWind", "\345\205\263\344\272\216", nullptr));
#if QT_CONFIG(tooltip)
        actDisplay->setToolTip(QCoreApplication::translate("QWMainWind", "\346\230\276\347\244\272\344\277\241\346\201\257", nullptr));
#endif // QT_CONFIG(tooltip)
